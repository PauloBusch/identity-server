...
namespace Identity.Service.Users
{
    public class UserService : IUserService
    {
        ...
        public async Task<Result> CreateAsync(User user)
        {
            ...
            if (existEmail) return new Result(EStatus.Conflict, nameof(user.Email), "Já existe um usuário com esse email");
        ...
        public async Task<Result> DeleteAsync(Guid id)
        {
            ...
            if (!exist) return new Result(EStatus.NotFund, nameof(id), "Usuário com esse id não existe");
        ...
        {
            var exist = await _userRepository.ExistByIdAsync(id);
            if (!exist) return new Result<User>(EStatus.NotFund, nameof(id), "Usuário com esse id não existe");
        ...
        public async Task<Result> UpdateAsync(User user)
        {
            ...
            if (!exist) return new Result(EStatus.NotFund, nameof(user.Id), "Usuário com esse id não existe");
